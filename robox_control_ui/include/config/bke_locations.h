...
#define STORAGE_O_00 42.5f, 125.7f, 43.0f
#define STORAGE_O_01 26.6f, 118.7f, 45.0f
#define STORAGE_O_02 15.8f, 106.0f, 47.0f
#define STORAGE_O_03 10.7f,  88.1f, 48.0f
#define STORAGE_O_04 11.5f,  63.7f, 51.0f
