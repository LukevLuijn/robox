...
#define BOARD_LOC_03 16.2f, -137.8f, 41.0f
...
#define STORAGE_O_00 42.5f, 125.7f, 42.0f
#define STORAGE_O_01 26.6f, 118.7f, 42.0f
#define STORAGE_O_02 15.8f, 106.0f, 42.0f
#define STORAGE_O_03 10.7f,  88.1f, 42.0f
#define STORAGE_O_04 11.5f,  63.7f, 42.0f
