...
#define STORAGE_O_00 42.5f, -234.3, 43.0f
#define STORAGE_O_01 26.6f, -241.3, 45.0f
#define STORAGE_O_02 15.8f, -254.0, 47.0f
#define STORAGE_O_03 10.7f, -271.9, 48.0f
#define STORAGE_O_04 11.5f, -296.3, 51.0f
