...
namespace Base
{
    ...
    {
        Z0.HomingSequence(MAX_SPEED_SEGMENT_00, MAX_ACCEL_SEGMENT_00);
        A2.HomingSequence(MAX_SPEED_SEGMENT_02, MAX_ACCEL_SEGMENT_02);
        A3.HomingSequence(MAX_SPEED_SEGMENT_03, MAX_ACCEL_SEGMENT_03);
        A1.HomingSequence(MAX_SPEED_SEGMENT_01, MAX_ACCEL_SEGMENT_01);
    }
