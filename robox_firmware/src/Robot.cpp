...
namespace Base
{
    ...
    void Robot::HomingSequence()
    {
        ...
        A2.HomingSequence(HOMING_SPEED_SEGMENT_02, HOMING_ACCEL_SEGMENT_02, MAX_SPEED_SEGMENT_01, MAX_ACCEL_SEGMENT_01);
        A3.HomingSequence(HOMING_SPEED_SEGMENT_03, HOMING_ACCEL_SEGMENT_03, MAX_SPEED_SEGMENT_02, MAX_ACCEL_SEGMENT_02);
        A1.HomingSequence(HOMING_SPEED_SEGMENT_01, HOMING_ACCEL_SEGMENT_01, MAX_SPEED_SEGMENT_03, MAX_ACCEL_SEGMENT_03);
    }
