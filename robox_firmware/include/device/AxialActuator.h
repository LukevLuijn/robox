...
namespace Device
{
    ...
    private:
        void HomeSingleMagnet(float homingSpeed, float homingAccel, float speed, float accel);
        void HomeDoubleMagnet(float homingSpeed, float homingAccel, float speed, float accel);
